package com.quxin.freshfun.proxy;
...
//	private AgentWithdrawService agentWithdrawService;
	...
	public List<GoodsPOJO> toMyBrand(Integer merchant_proxy_id) {
		...
		// for (GoodsPOJO goodsPOJO : goods) {
		// Double salesMoney = goodsService.getAllSales(goodsPOJO.getId()) *
		// Double.parseDouble(goodsPOJO.getShopPriceString());
	...
	public  Map<String, Object> getIncome(String userId) {
		...
		map.put("totalRevenue", totalRevenue*0.2);
		map.put("unbilledRevenue", unbilledRevenue*0.2);
		return map;
