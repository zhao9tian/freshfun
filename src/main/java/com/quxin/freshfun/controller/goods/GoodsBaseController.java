...
public class GoodsBaseController {
    ...
    @ResponseBody
    public Map<String, Object> getSpecialTheme(Integer page, Integer pageSize) {
    ...
    @ResponseBody
    public Map<String, Object> recommendList() {
        Map<String, Object> map = new HashMap<>();
        Map<String, Object> resultMap = new HashMap<>();
    ...
    @ResponseBody
    public Map<String,Object> getGoodsList(Integer page,Integer pageSize){
        Map<String, Object> map = new HashMap<>();
        Map<String, Object> resultMap = new HashMap<>();
        if (pageValidate(page, pageSize, map, resultMap)) return resultMap;
        int currentPage = (page - 1) * pageSize;
    ...
    @ResponseBody
    public Map<String,Object> getCategory(Integer categoryKey){
        Map<String, Object> map = new HashMap<>();
        Map<String, Object> resultMap = new HashMap<>();
        Map<String, Object> resultData = Maps.newHashMap();
        if (isParameter(categoryKey, map, resultMap)) return resultMap;

        List<GoodsOut> category = goodsBaseService.getCategory(categoryKey);
        String categoryImg = goodsBaseService.getCategoryImg(categoryKey);
    ...
    @ResponseBody
    public Map<String,Object> getSpecialDetails(Long specialId){
        Map<String, Object> map = new HashMap<>();
        Map<String, Object> resultMap = new HashMap<>();
    ...
    public Map<String,Object> getGoodsDetails(Long goodsId){
        ...
        Map<String, Object> goodsDetailsList = goodsBaseService.getGoodsDetails(goodsId);
